...
.vendor-googleapis:
	...
	git sparse-checkout set --no-cone google/api google/type && \
	git checkout
	...
	mkdir -p $(VENDOR_PROTO_PATH)/google/type
	find $(VENDOR_PROTO_PATH)/googleapis/google/type -maxdepth 1 -type f -exec mv {} $(VENDOR_PROTO_PATH)/google/type \;
